...
public class WdpDslPackageImpl extends EPackageImpl implements WdpDslPackage {
	 ...
	 * @generated
	 */
	public EAttribute getDeletion_PostsByTitle() {
	...
	public EAttribute getDeletion_MenusByName() {
		return (EAttribute)deletionEClass.getEStructuralFeatures().get(8);
	}
	...
	public EReference getDeletion_CommentsByPostDateAuthor() {
		return (EReference)deletionEClass.getEStructuralFeatures().get(9);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(deletionEClass, DELETION__POSTS_BY_TITLE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDeletion_PostsByTitle(), ecorePackage.getEString(), "postsByTitle", null, 0, -1, Deletion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
