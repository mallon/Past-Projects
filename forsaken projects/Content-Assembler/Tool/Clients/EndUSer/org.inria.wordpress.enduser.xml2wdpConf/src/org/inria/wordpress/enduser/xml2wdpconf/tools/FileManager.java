...
public class FileManager {
	...
	public String getDirectoriesURI(String locationURI){
		String directoriesURI = this.getDirectories(locationURI.split("/"));
	...
	public String getRootDirectoryPath(String directoryName){
		String fileSeparator = this.getSystemFileSeparator();
		String rootDirectoryPath = fileSeparator + directoryName + fileSeparator;
