 ...
 * <ul>
 *   <li>{@link org.inria.wordpress.wdpdsl.wdpDsl.impl.MetaImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetaImpl extends MinimalEObjectImpl.Container implements Meta {
	...
	protected EClass eStaticClass() {
		return WdpDslPackage.Literals.META;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WdpDslPackage.META__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WdpDslPackage.META__TITLE:
				return getTitle();
		}
