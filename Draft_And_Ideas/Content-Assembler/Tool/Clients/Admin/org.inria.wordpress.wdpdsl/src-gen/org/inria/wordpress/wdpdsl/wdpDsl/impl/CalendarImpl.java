 ...
 * <ul>
 *   <li>{@link org.inria.wordpress.wdpdsl.wdpDsl.impl.CalendarImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CalendarImpl extends MinimalEObjectImpl.Container implements Calendar {
	...
	protected EClass eStaticClass() {
		return WdpDslPackage.Literals.CALENDAR;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WdpDslPackage.CALENDAR__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WdpDslPackage.CALENDAR__TITLE:
				return getTitle();
		}
