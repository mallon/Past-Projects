	...
	public XmlFreePlaneTransfo(String xmlFilePath){
		try{
			...
			try {
				...
				String xmlEcore = "metamodels"+File.separator+"XML.ecore";
				String xmlEcoreURL = XmlFreePlaneTransfo.class.getResource(xmlEcore).getPath();
			...
			try {
				...
				String woclEcore = "metamodels"+File.separator+"wdpDsl.ecore";
				String woclEcoreURL = XmlFreePlaneTransfo.class.getResource(woclEcore).getPath();				
			...
			String absolutePathToTransfo = "atlTransformations"+File.separator;	
			InputStream xlm2woclLibStream = XmlFreePlaneTransfo.class.getResourceAsStream(absolutePathToTransfo + "WSXML2WDPDSLHelpers.asm");
			...
			InputStream xlm2woclStream = XmlFreePlaneTransfo.class.getResourceAsStream(absolutePathToTransfo + "WSXML2WDPDSL.asm");
